...
router.get('/profile', User.authorize(), (req, res) => {
  // console.log('req.user:', req.user);
  res.send(req.user);
});

router.delete('/all', User.authorize(), (req, res) => {
  User.remove({}, err => {
...
// router.put('/:id/toggleAdmin', User.authorize(), (req, res) => {
//   if(req.user._id.toString() === req.params.id){
//     return res.status(400).send({error: "Can\'t toggle yourself, Slliy Girl"});
//   }
